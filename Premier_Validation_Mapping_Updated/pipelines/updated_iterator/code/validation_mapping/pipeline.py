...
def pipeline(spark: SparkSession) -> None:
    ...
    df_validateTablesIterator = validateTablesIterator(Config.validateTablesIterator).apply(spark, df_groupByTable)
    validationOutput(spark, df_validateTablesIterator)
